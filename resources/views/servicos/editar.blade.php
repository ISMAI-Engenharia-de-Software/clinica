...
@section('content')
    ...
    <div class="container">
        <h1>Atualizar Serviço #{{$servico->id}}</h1>
        <form method="POST" action="{{ route('servicos.atualizar', $servico->id) }}">
            @method('patch')
            @csrf
            ...
            <div class="form-group">
                ...
                <input required chosen class="form-control" value="{{ $servico->paciente_nif }}" list="pacientes"
            ...
            <div class="form-group">
                ...
                <input required type="text" name="nome" class="form-control" value="{{ $servico->nome }}">
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input required type="text" name="tipo" class="form-control" value="{{ $servico->tipo }}">
                @if ($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <input required type="text" name="condicoes" class="form-control" value="{{ $servico->condicoes }}">
            ...
            <div class="form-group" style="margin-bottom: 20px">
                ...
                <input required type="text" name="gastos" class="form-control" value="{{ $servico->gastos }}">
